        ...
        <div class="page-wrapper">
                                    ...
                                    <table class="table">
                                        ...
                                        <?php foreach($Valiny as $res){?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?php echo site_url('Tache/ListeDeveloppeur/'.$res->{'IDPROJET'})?>">ajouterDeveloppeur</a></td>
            ...
            <div class="row justify-content-center">
                ...
                <div class="featured-btn-wrap">
                    ...
                    <a href="<?php echo site_url('Tache/ListeProjet/'.$i)?>"class="btn btn-danger"><?php echo $i ?></a><?php }?>
                    </div>
                </div>
            </div>
            </div>
