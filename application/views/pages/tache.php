                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="<?php echo site_url("Upload_Files/upload")?>" enctype="multipart/form-data">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>Nom tache</th>
                                        ...
                                        <?php foreach($valiny as $res){?>
                                            <tr>
                                                ...
                                                <input type="hidden" name='id' value="<?php echo $res->{'IDTACHE'}?>">
                                                <input type="hidden" name='idprojet' value="<?php echo $res->{'IDPROJET'}?>">
                                                <td><input type="file" name="files[]" multiple>
                                                <button type="submit" name="fileSubmit" >valider</button></td>
                                                <td><a href="<?php echo base_url()?>assets/uploads/files/<?php echo $res->{'NOM'}?>"><?php echo $res->{'NOM'}?><a></td>
                                        </tr><?php }?>
                                        </tbody>
                                    </table></form>
                                </div>
