        ...
        <div class="page-wrapper">
                                    ...
                                    <table class="table">
                                        ...
                                        <?php foreach($Valiny as $res){?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?php echo site_url('Manager/getAvancement/'.$res->{'IDPROJET'})?>">Voit l'avancement</a></td>
                                                </td>     
                                        </tr><?php }?>
                                        </tbody>
                                    </table>
            ...
            <div class="row justify-content-center">
                ...
                <div class="featured-btn-wrap">
                    ...
                    <a href="<?php echo site_url('Manager/ListeProjet/'.$i)?>"class="btn btn-danger"><?php echo $i ?></a><?php }?>
                    <a href="<?php echo site_url('Manager/getGlobaleAvancement')?>" class="btn btn-danger">Voit l'avancement</a>
                    </div>
                </div>
            </div>
