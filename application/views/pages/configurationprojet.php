                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo site_url("Affectation/getSuppression")?>" method="post">
                                        <div class="form-group row">
                                            ...
                                            <h5>Si vous avez supprimer cette projet 
                                            tous les taches rattacher avec cette projet sont supprimer aussi  
                                            </h5>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 ml-auto">
                                                <a href="<?php echo site_url("Affectation/getSuppressionF/$id")?>" class="btn btn-primary" name="oui">oui</a>
                                                <a href="<?php echo site_url("Affectation/getAffectation_Projet")?>" class="btn btn-primary" name="nom">nom</a>
                                            </div>
                                        </div>
                                    </form>
