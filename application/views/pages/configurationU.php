                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo site_url("Affectation/getSuppression")?>" method="post">
                                        <div class="form-group row">
                                            ...
                                            <h5>Si vous avez supprimer cette Utilisateur 
                                           Il sera desaffecter par sa tache
                                            </h5>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 ml-auto">
                                                <a href="<?php echo site_url("Affectation/getSuppressionUT")?>" class="btn btn-primary" name="oui">oui</a>
