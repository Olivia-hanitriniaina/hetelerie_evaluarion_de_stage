            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <li> <a class="has-arrow  " href="<?php echo site_url("Welcome/index")?>" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Deconnexion</span></a>
                        ...
                        <li> <a class="has-arrow  " href="<?php echo site_url("Affectation/getAffectation_Projet")?>" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Affectation</span></a>
                        </li>
                        <li> <a class="has-arrow  " href="<?php echo site_url("Projet/crud_profil")?>" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Projet</span></a>
                        </li>
                    </ul>
                </nav>
