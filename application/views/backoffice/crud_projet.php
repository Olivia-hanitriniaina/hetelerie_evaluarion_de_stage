            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <li> <a class="has-arrow  " href="<?php echo site_url("Welcome/index")?>" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Deconnexion</span></a>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Profile</span></a>
                        </li>
                        ...
                        <li> <a class="has-arrow  " href="<?php echo site_url("Affectation/getAffectation_Utilisateur")?>" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Affectation</span></a>
                        </li>
                        <li> <a class="has-arrow  " href="<?php echo site_url("Profile/crud_profil")?>" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Projet</span></a>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Page pour les profiles d'utilisateur</h3> </div>
            </div>
            <!-- End Bread crumb -->
            <!-- Container fluid  -->
            <div class="container-fluid">
                ...
                <div class="row bg-white m-l-0 m-r-0 box-shadow ">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Ajouter, Modifier, Lister, suprimer profile</h4>
